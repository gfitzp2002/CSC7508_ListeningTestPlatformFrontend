            ...
            <Card className="mb-4">
              <Card.Body>
                <Row>
                  ...
                  <Col sm="9">
                    <Card.Text className="text-muted">{`${userProfile.personalInfo.userForename} ${userProfile.personalInfo.userSurname}`}</Card.Text>
                  </Col>
                </Row>
                <hr />
                <Row>
                  ...
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.personalInfo.userEmail}</Card.Text>
                  </Col>
                </Row>
                <hr />
               </Card.Body>
            ...
            <Card className="mb-4">
              <Card.Body>
                <Row>
                  ...
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.quizStats.totalPoints}</Card.Text>
                  </Col>
                </Row>
                <hr />
                <Row>
                  <Col sm="3">
                    <Card.Text>Strongest Category</Card.Text>
                  </Col>
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.quizStats.strongCategory}</Card.Text>
                  </Col>
                </Row>
                <hr />
                <Row>
                  <Col sm="3">
                    <Card.Text>Most Played</Card.Text>
                  </Col>
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.quizStats.mostPlayed}</Card.Text>
                  </Col>
                </Row>
                <hr />
                <Row>
                  <Col sm="3">
                    <Card.Text>Days in a row streak</Card.Text>
                  </Col>
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.quizStats.daysInARow}</Card.Text>
                  </Col>
                </Row>
                <hr />
                <Row>
                  <Col sm="3">
                    <Card.Text>Days played this month</Card.Text>
                  </Col>
                  <Col sm="9">
                    <Card.Text className="text-muted">{userProfile.quizStats.daysThisMonth}</Card.Text>
                  </Col>
                </Row>
                <hr />
               </Card.Body>
